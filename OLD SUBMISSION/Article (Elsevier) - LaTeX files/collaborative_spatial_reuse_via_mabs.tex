...
%\francesco{As later shown, this condition holds as long as adversarial WNs are able to compete for channel resources on equal terms. Otherwise, selfish learning would lead to unfairness situations, since WNs in a dominant position would take advantage of their situation, thus harming the performance of WNs in weaker situations.}
