...
figure
plot(1:8, mean_tpt_num_channels_eg, '-x', 'LineWidth', 2, 'MarkerSize', 10);
hold on
plot(1:8, mean_tpt_num_channels_exp3, '-o', 'LineWidth', 2, 'MarkerSize', 10);
plot(1:8, mean_tpt_num_channels_ucb, '--s', 'LineWidth', 2, 'MarkerSize', 10);
plot(1:8, mean_tpt_num_channels_ts, '--d', 'LineWidth', 2, 'MarkerSize', 10);
axis([1 8 0 1000])
...
figure
plot(1:8, mean_std_num_channels_eg, '-x', 'LineWidth', 2, 'MarkerSize', 10);
hold on
plot(1:8, mean_std_num_channels_exp3, '-o', 'LineWidth', 2, 'MarkerSize', 10);
plot(1:8, mean_std_num_channels_ucb, '--s', 'LineWidth', 2, 'MarkerSize', 10);
plot(1:8, mean_std_num_channels_ts, '--d', 'LineWidth', 2, 'MarkerSize', 10);
axis([1 8 0 300])
legend({'e-greedy', 'EXP3', 'UCB', 'TS'})
set(gca,'FontSize', 22)
