...
[tpt_evolution_per_wlan_ots, times_arm_has_been_played_ots, regret_per_wlan_ots] = alternative_thompson_sampling(wlans);
...
% Save the workspace
save('./Output/simulation_1_6_workspace.mat')