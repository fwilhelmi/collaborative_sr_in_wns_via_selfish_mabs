...
disp('-----------------------')
disp('SIM 1_5_1_1: dynamic e-greedy (async.)')
disp('-----------------------')
...
[tpt_evolution_per_wlan_eg_stage_1, times_arm_has_been_played_eg_stage_1, ...
    ...
    egreedy_with_memory( wlans_stage_1, initialEpsilon, upperBoundThroughputPerWlanStage1, rewardPerArm, 1, 2500, iteration_per_wlans );
...
[tpt_evolution_per_wlan_eg_stage_2, times_arm_has_been_played_eg_stage_2, ...
    ...
    egreedy_with_memory( wlans_stage_2, initialEpsilon, upperBoundThroughputPerWlanStage2, rewardPerArmStage1, 2500, 5000, iterationPerWlan1 );
...
[tpt_evolution_per_wlan_eg_stage_3, times_arm_has_been_played_eg_stage_3, ...
    ...
    egreedy_with_memory( wlans_stage_3, initialEpsilon, upperBoundThroughputPerWlanStage3, rewardPerArmStage2, 5000, 10000, iterationPerWlan2 );
...
% Save the workspace
save('./Output/simulation_1_5_1_1_workspace.mat')