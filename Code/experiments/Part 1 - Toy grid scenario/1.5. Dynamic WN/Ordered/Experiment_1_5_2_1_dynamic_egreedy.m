...
disp('-----------------------')
disp('SIM 1_5_2_1: dynamic e-greedy (ordered)')
disp('-----------------------')
...
[tpt_evolution_per_wlan_eg_stage_1, times_arm_has_been_played_eg_stage_1, regret_per_wlan_eg_stage_1, ...
    ...
    ordered_egreedy_cumulative_with_memory( wlans_stage_1, epsilon, upperBoundThroughputPerWlanStage1, ...
...
[tpt_evolution_per_wlan_eg_stage_2, times_arm_has_been_played_eg_stage_2, ...
    ...
    ordered_egreedy_cumulative_with_memory( wlans_stage_2, epsilon, upperBoundThroughputPerWlanStage2, rewardPerArmStage1, cumulative_reward, 2500, 5000, iterationPerWlanStage1 );
...
[tpt_evolution_per_wlan_eg_stage_3, times_arm_has_been_played_eg_stage_3, ...
    ...
    ordered_egreedy_cumulative_with_memory( wlans_stage_3, epsilon, upperBoundThroughputPerWlanStage3, rewardPerArmStage2, cumulative_reward, 5000, 10000, iterationPerWlanStage2 );
...
% Save the workspace
save('./Output/simulation_1_5_2_1_workspace.mat')