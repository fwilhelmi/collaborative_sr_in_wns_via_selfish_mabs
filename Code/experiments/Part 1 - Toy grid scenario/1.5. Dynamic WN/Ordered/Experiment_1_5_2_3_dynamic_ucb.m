...
disp('-----------------------')
disp('SIM 1_5_2_3: dynamic UCB (ordered)')
disp('-----------------------')
...
[tpt_evolution_per_wlan_ucb_stage_1, times_arm_has_been_played_ucb_stage_1, ...
    ...
    ucb_with_memory(wlans_stage_1, upperBoundThroughputPerWlanStage1, 1, 2500);
...
[tpt_evolution_per_wlan_ucb_stage_2, times_arm_has_been_played_ucb_stage_2, ...
    ...
    ucb_with_memory(wlans_stage_2, upperBoundThroughputPerWlanStage2, 2500, 5000);
...
[tpt_evolution_per_wlan_ucb_stage_3, times_arm_has_been_played_ucb_stage_3, ...
    ...
    ucb_with_memory(wlans_stage_3, upperBoundThroughputPerWlanStage3, 5000, 10000);
...
% Save the workspace
save('./Output/simulation_1_5_2_3_workspace.mat')