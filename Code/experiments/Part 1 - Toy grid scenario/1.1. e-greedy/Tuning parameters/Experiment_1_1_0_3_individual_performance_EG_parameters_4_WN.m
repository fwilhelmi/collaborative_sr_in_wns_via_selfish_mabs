...
%%% individual performance of e-greedy for e_0 = 1. We display i) the
...
[tpt_evolution_per_wlan_eg_1_3, times_arm_has_been_played_1_3, regret_per_wlan_1_3] = egreedy( wlans, initialEpsilon );

% Plot the results
if plotResults
    display_results_individual_performance(wlans, tpt_evolution_per_wlan_eg_1_3, times_arm_has_been_played_1_3, 'e-greedy');
end
