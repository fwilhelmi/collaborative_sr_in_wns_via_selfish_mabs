...
[tpt_evolution_per_wlan_eg_1_1, times_arm_has_been_played_1_1] = egreedy( wlans, initialEpsilon );

% Plot the results
if plotResults
    display_results_individual_performance(wlans, tpt_evolution_per_wlan_eg_1_1, times_arm_has_been_played_1_1, 'e-greedy');
end
