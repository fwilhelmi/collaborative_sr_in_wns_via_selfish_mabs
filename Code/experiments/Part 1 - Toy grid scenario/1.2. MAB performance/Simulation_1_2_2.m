...
%%% performance achieved by applying EXP3.
...
disp('-----------------------')
disp('Sim 1_2_2: EXP3 (Toy scenario)')
disp('-----------------------')
...
[tpt_evolution_per_wlan_concurrent_exp3, times_arm_has_been_played_concurrent_exp3, regret_per_wlan_concurrent_exp3]  = ...
    concurrent_exp3(wlans, gamma, initialEta, upperBoundThroughputPerWlan);
% Compute the throughput experienced per WLAN at each iteration (sequential)
[tpt_evolution_per_wlan_sequential_exp3, times_arm_has_been_played_sequential_exp3, regret_per_wlan_sequential_exp3]  = ...
    sequential_exp3(wlans, gamma, initialEta, upperBoundThroughputPerWlan);

% Plot the results
if plotResults
    display_results_individual_performance(wlans, tpt_evolution_per_wlan_concurrent_exp3, ...
        times_arm_has_been_played_concurrent_exp3, max_max_min, agg_tpt_max_pf, 'EXP3_concurrent');
   display_results_individual_performance(wlans, tpt_evolution_per_wlan_sequential_exp3, ...
       times_arm_has_been_played_sequential_exp3, max_max_min, agg_tpt_max_pf, 'EXP3_sequential');
end

% Save the workspace
save('./output/simulation_1_2_2_workspace.mat')