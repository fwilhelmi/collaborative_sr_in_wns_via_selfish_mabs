...
[tpt_evolution_per_wlan_exp3_2_3, times_arm_has_been_played_2_3]  = exp3(wlan, gamma, initialEta);

% Plot the results
if plotResults
    display_results_individual_performance(wlan, tpt_evolution_per_wlan_exp3_2_3, ...
        times_arm_has_been_played_2_3, 'EXP3');
end

% Save the workspace
save('./output/simulation_2_3_workspace.mat')