...
disp('----------------------------------------------')
disp('PLOT RESULTS OF EXPERIMENT 2')
disp('----------------------------------------------')
...
load('tpt_evolution_per_wlan_exp3_2_1.mat');
load('tpt_evolution_per_wlan_exp3_2_2.mat');
load('tpt_evolution_per_wlan_exp3_2_3.mat');

num_wlans = size(tpt_evolution_per_wlan_exp3_2_1, 2);

permanent_throughput_2_1 = tpt_evolution_per_wlan_exp3_2_1(permanentInterval,:);
permanent_throughput_2_2 = tpt_evolution_per_wlan_exp3_2_2(permanentInterval,:);
permanent_throughput_2_3 = tpt_evolution_per_wlan_exp3_2_3(permanentInterval,:);
...
xlabel('Throughput (Mbps), \eta_0 = 0.1','fontsize', 24)
ylabel('Freq.','fontsize', 24)
set(gca,'FontSize', 22)
axis([0 700 0 5000])
subplot(3,1,2)
hist(permanent_throughput_2_2(:), 50)
xlabel('Throughput (Mbps), \eta_0 = 0.5','fontsize', 24)
ylabel('Freq.','fontsize', 24)
set(gca,'FontSize', 22)
axis([0 700 0 5000])
subplot(3,1,3)
hist(permanent_throughput_2_3(:), 50)
xlabel('Throughput (Mbps), \eta_0 = 1','fontsize', 24)
ylabel('Freq.','fontsize', 24)
set(gca,'FontSize', 22)
axis([0 700 0 5000])
% Save Figure
figName = 'experiment_2_hist_throughput';
...
legend([hBar, h2],{'\eta_0 = 0.1', '\eta_0 = 0.5', '\eta_0 = 1', 'Optimal (PF)'});
% Save Figure
figName = 'experiment_2_mean_tpt';
savefig(['./Output/' figName '.fig'])
saveas(gcf,['./Output/' figName],'png')
close 
...
axis([1 20 30 70]);
subplot(3,1,1)
plot(1 : totalIterations, tpt_evolution_per_wlan_exp3_2_1(:,1));
hold on
xlabel('Iteration','fontsize', 24)
legend('\eta_0 = 0.1')
set(gca,'FontSize', 22)
subplot(3,1,2)
plot(1 : totalIterations, tpt_evolution_per_wlan_exp3_2_2(:,1), 'r');
xlabel('Iteration','fontsize', 24)
legend('\eta_0 = 0.5')
set(gca,'FontSize', 22)
subplot(3,1,3)
plot(1 : totalIterations, tpt_evolution_per_wlan_exp3_2_3(:,1), 'g');
xlabel('Iteration','fontsize', 24)
legend('\eta_0 = 1')
set(gca,'FontSize', 22)
ylabel('Throughput WLAN_{A} (Mbps)','fontsize', 24)
% Save Figure
figName = 'experiment_2_variability';
savefig(['./Output/' figName '.fig'])
saveas(gcf,['./Output/' figName],'png')