...
disp('------------------------------------')
disp('SIM 1_3_1_4: dynamic TS (concurrent)')
disp('------------------------------------')
...
[tpt_evolution_per_wlan_ts_stage_1, times_arm_has_been_played_ts_stage_1, ...
    ...
    concurrent_thompson_sampling_with_memory(wlans_stage_1, upperBoundThroughputPerWlanStage1, 1, 2500, estimatedRewardPerWlan, timesArmHasBeenPlayed);
...
[tpt_evolution_per_wlan_ts_stage_2, times_arm_has_been_played_ts_stage_2, ...
    ...
    concurrent_thompson_sampling_with_memory(wlans_stage_2, upperBoundThroughputPerWlanStage2, 2500, 5000, estimatedRewardPerWlanStage1, times_arm_has_been_played_ts_stage_1);
...
[tpt_evolution_per_wlan_ts_stage_3, times_arm_has_been_played_ts_stage_3, ...
    ...
    concurrent_thompson_sampling_with_memory(wlans_stage_3, upperBoundThroughputPerWlanStage3, 5000, 10000, estimatedRewardPerWlanStage2, times_arm_has_been_played_ts_stage_2);
...
% Save the workspace
save('./Output/simulation_1_4_1_4_workspace.mat')