...
disp('--------------------------------------')
disp('SIM 1_3_1_2: dynamic EXP3 (concurrent)')
disp('--------------------------------------')
...
[tpt_evolution_per_wlan_exp3_stage_1, times_arm_has_been_played_exp3_stage_1, ...
    ...
    concurrent_exp3_with_memory(wlans_stage_1, gamma, initialEta, ...
...
[tpt_evolution_per_wlan_exp3_stage_2, times_arm_has_been_played_exp3_stage_2, ...
    ...
    concurrent_exp3_with_memory(wlans_stage_2, gamma, initialEta, ...
...
[tpt_evolution_per_wlan_exp3_stage_3, times_arm_has_been_played_exp3_stage_3, ...
    ...
    concurrent_exp3_with_memory(wlans_stage_3, gamma, initialEta, ...
...
% Save the workspace
save('./Output/simulation_1_4_1_2_workspace.mat')