...
disp('-----------------------------------------')
disp('SIM 1_3_1_1: dynamic e-greedy (concurrent)')
disp('-----------------------------------------')
...
initialEpsilon = 1;
iteration_per_wlans = zeros(1, nWlans);
...
[tpt_evolution_per_wlan_eg_stage_1, times_arm_has_been_played_eg_stage_1, ...
    regret_per_wlan_eg_stage_1 , meanRewardPerAction_stage_1, rewardPerArmStage1, iterationPerWlan1] = ...
    concurrent_egreedy_with_memory( wlans_stage_1, initialEpsilon, upperBoundThroughputPerWlanStage1, rewardPerArm, 1, 2500, iteration_per_wlans );
...
[tpt_evolution_per_wlan_eg_stage_2, times_arm_has_been_played_eg_stage_2, ...
    regret_per_wlan_eg_stage_2 , meanRewardPerAction_stage_2, rewardPerArmStage2, iterationPerWlan2] = ...
    concurrent_egreedy_with_memory( wlans_stage_2, initialEpsilon, upperBoundThroughputPerWlanStage2, rewardPerArmStage1, 2500, 5000, iterationPerWlan1 );
...
[tpt_evolution_per_wlan_eg_stage_3, times_arm_has_been_played_eg_stage_3, ...
    regret_per_wlan_eg_stage_3 , meanRewardPerAction_stage_3, rewardPerArmStage3, iterationPerWlan3] = ...
    concurrent_egreedy_with_memory( wlans_stage_3, initialEpsilon, upperBoundThroughputPerWlanStage3, rewardPerArmStage2, 5000, 10000, iterationPerWlan2 );
...
% Save Figure
fig_name = ['temporal_aggregate_tpt_dynamic_scenario_async_EG'];
...
% Save the workspace
save('./Output/simulation_1_4_1_1_workspace.mat')