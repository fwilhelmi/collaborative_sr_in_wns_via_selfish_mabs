...
disp('-------------------------------------')
disp('SIM 1_3_1_3: dynamic UCB (concurrent)')
disp('-------------------------------------')
...
[tpt_evolution_per_wlan_ucb_stage_1, times_arm_has_been_played_ucb_stage_1, ...
    ...
    concurrent_ucb_with_memory(wlans_stage_1, upperBoundThroughputPerWlanStage1, 1, 2500);
...
[tpt_evolution_per_wlan_ucb_stage_2, times_arm_has_been_played_ucb_stage_2, ...
    ...
    concurrent_ucb_with_memory(wlans_stage_2, upperBoundThroughputPerWlanStage2, 2500, 5000);
...
[tpt_evolution_per_wlan_ucb_stage_3, times_arm_has_been_played_ucb_stage_3, ...
    ...
    concurrent_ucb_with_memory(wlans_stage_3, upperBoundThroughputPerWlanStage3, 5000, 10000);
...
% Save Figure
fig_name = ['temporal_aggregate_tpt_dynamic_scenario_async_UCB'];
...
% Save the workspace
save('./Output/simulation_1_4_1_3_workspace.mat')