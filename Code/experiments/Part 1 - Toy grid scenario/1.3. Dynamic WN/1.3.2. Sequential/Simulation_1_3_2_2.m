...
%%% performance achieved by applying EXP3 in a dynamic scenario.
...
disp('--------------------------------------')
disp('SIM 1_3_2_2: dynamic EXP3 (sequential)')
disp('--------------------------------------')
...
[tpt_evolution_per_wlan_exp3_stage_1, times_arm_has_been_played_exp3_stage_1, ...
    ...
    sequential_exp3_with_memory(wlans_stage_1, gamma, initialEta, ...
...
[tpt_evolution_per_wlan_exp3_stage_2, times_arm_has_been_played_exp3_stage_2, ...
    ...
    sequential_exp3_with_memory(wlans_stage_2, gamma, initialEta, ...
...
[tpt_evolution_per_wlan_exp3_stage_3, times_arm_has_been_played_exp3_stage_3, ...
    ...
    sequential_exp3_with_memory(wlans_stage_3, gamma, initialEta, ...
...
% Save Figure
fig_name = ['temporal_aggregate_tpt_dynamic_scenario_ordered_EXP3'];
...
% Save the workspace
save('./Output/simulation_1_4_2_2_workspace.mat')