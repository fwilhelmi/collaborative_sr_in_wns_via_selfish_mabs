...
disp('-----------------------')
disp('SIM 1_1_1: e-greedy (toy scenario) finding the best parameters')
disp('-----------------------')
...
for r = 1 : totalRepetitions
    ...
    for e = 1 : size(initialEpsilon, 2)        
        ...
        [tptEvolutionPerWlan, timesArmHasBeenPlayed] = concurrent_egreedy( wlans, initialEpsilon(e), upperBoundThroughputPerWlan );
...
% Save the workspace
save('simulation_1_1_1_workspace.mat')