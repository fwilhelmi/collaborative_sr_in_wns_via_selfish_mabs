...
%%% individual performance of EXP3 for eta_0 = 0.1. We display i) the
...
[tpt_evolution_per_wlan_exp3_2_1, times_arm_has_been_played_2_1]  = exp3(wlan, gamma, initialEta);

% Plot the results
if plotResults
    display_results_individual_performance(wlan, ...
    tpt_evolution_per_wlan_exp3_2_1, times_arm_has_been_played_2_1, 'EXP3');
end
