...
for i = 1 : size(wlansSizes, 2)
    subplot(2,2,i)
    errorbar(1 : size(intervals,2), plot_mean_egreedy(i, :), plot_std_egreedy(i, :), 'r', 'LineWidth', 2,'MarkerSize', 10) 
    hold on
    errorbar(1 : size(intervals,2), plot_mean_exp3(i, :), plot_std_exp3(i, :), 'b', 'LineWidth', 2,'MarkerSize', 10) 
    errorbar(1 : size(intervals,2), plot_mean_ucb(i, :), plot_std_ucb(i, :), 'g', 'LineWidth', 2,'MarkerSize', 10) 
    errorbar(1 : size(intervals,2), plot_mean_ts(i, :), plot_std_ts(i, :), 'c', 'LineWidth', 2,'MarkerSize', 10) 
...
legend({'\epsilon-greedy (concurrent)', 'EXP3 (concurrent)', 'UCB (concurrent)', 'Thompson s. (concurrent)'})
...
for i = 1 : size(wlansSizes, 2)
    ...
    %errorbar(1 : size(intervals,2), plot_mean_oegreedy(i, :), plot_std_oegreedy(i, :), '-r', 'LineWidth', 2,'MarkerSize', 10) 
    %hold on
...
%     errorbar(1 : size(intervals,2), plot_mean_oexp3(i, :), plot_std_oexp3(i, :), '-b', 'LineWidth', 2,'MarkerSize', 10) 
%     errorbar(1 : size(intervals,2), plot_mean_oucb(i, :), plot_std_oucb(i, :), '-g', 'LineWidth', 2,'MarkerSize', 10) 
%     errorbar(1 : size(intervals,2), plot_mean_ots(i, :), plot_std_ots(i, :), '-c', 'LineWidth', 2,'MarkerSize', 10) 
    title(['N = ' num2str(wlansSizes(i))])
    xlabel('Learning interval')       
    ylabel('Mean av. throughput (Mbps)')     
    set(gca,'FontSize', 20)
...
%legend({'\epsilon-greedy (sequential)', 'EXP3 (sequential)', 'UCB (sequential)', 'Thompson s. (sequential)'})
...
%         aggTptEvolution{s}(r,:) = sum(throughputEvolutionPerWlanEgreedyDefault{s,r}');
%         meanTptEvolution{s}(r,:) = mean(throughputEvolutionPerWlanEgreedyDefault{s,r}');
%         stdTptEvolution{s}(r,:) = std(throughputEvolutionPerWlanEgreedyDefault{s,r}');
%     end
% end
% 
