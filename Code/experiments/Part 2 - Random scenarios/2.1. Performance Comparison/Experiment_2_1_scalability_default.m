...
for s = 1 : size(nWlans, 2)    
    ...
    for scenario = 1 : totalScenarios
        ...
        throughputEvolutionPerWlanEgreedy{s, scenario}  = ...
            egreedy(wlans{s,scenario}, initialEpsilon, upperBoundThroughputPerWlan, ...
