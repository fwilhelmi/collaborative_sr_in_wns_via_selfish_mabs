...
function [ tptExperiencedPerWlan, timesArmHasBeenPlayed, regretExperiencedPerWlan, estimatedRewardPerWlan ] = ...
    concurrent_thompson_sampling_with_memory( wlans, upperBoundThroughputPerWlan, first_iteration, last_iteration, ...
    estimatedRewardPerWlan, timesArmHasBeenPlayed, varargin )
