...
function [ tptExperiencedPerWlan, timesArmHasBeenPlayed, regretExperiencedPerWlan, meanRewardPerAction, rewardPerArm, iteration_per_wlan ] = ...
    concurrent_egreedy_with_memory( wlans, initialEpsilon, upperBoundThroughputPerWlan, rewardPerArm, first_iteration, last_iteration, iteration_per_wlan, varargin )
